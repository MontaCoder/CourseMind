      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <p className="mt-4 text-lg text-muted-foreground">
              At {companyName}, we believe in the transformative power of education and the endless possibilities that Artificial Intelligence unlocks. That's why we've developed CourseMind, a revolutionary SaaS product designed to make course creation seamless, efficient, and intelligent.
            </p>
            <p className="mt-4 text-lg text-muted-foreground">
              Empowering educators, professionals, and organizations to create exceptional learning experiences effortlessly is at the heart of what we do. CourseMind embodies our commitment to leveraging AI technology to simplify the course development process and unlock new realms of educational excellence. Founded with a passion for innovation, MontaCoder has been on a journey to redefine the intersection of education and technology. Our team of experts, driven by a shared vision, has dedicated years to create CourseMind as a testament to our commitment to advancing the field of online learning. At MontaCoder, quality is non-negotiable. CourseMind is the result of meticulous development, incorporating the latest advancements in AI technology to provide you with a tool that exceeds expectations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            Embark on a journey of innovation and educational excellence with CourseMind. Whether you're an educator, a professional, or an organization looking to elevate your learning programs, {companyName} is here to support you every step of the way.
          </p>
