  ...
  return (
    <section className="py-20 md:py-32 px-6 md:px-10 bg-primary/5 relative">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="cta-container opacity-0 bg-card rounded-2xl p-8 md:p-12 border border-border/50 shadow-xl overflow-hidden relative dark:border-border/70 dark:bg-card/90">
          {/* Abstract shapes */}
